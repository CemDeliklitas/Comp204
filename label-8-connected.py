...
def main():
    ...
    img = Image.open('C:/Users/HP/PycharmProjects/Comp204/picture.jpg')
        ...
        for j in range(1, ncol - 1):
                ...
                if c == ONE:
                    ...
                    if min_label == max_label:
                        ...
                        if min_label != label_k and label_k != max_label:
                            update_array(a,min_label,label_k)
                        if min_label != label_m and label_m  != max_label:
                            update_array(a, min_label,label_m)
                        if min_label != label_a and label_a  != max_label:
                            update_array(a, min_label,label_a)
                        if min_label != label_s and label_s  != max_label:
                            update_array(a, min_label,label_s)
                        if min_label != label_d and label_d  != max_label:
                            update_array(a, min_label,label_d)
                        if min_label != label_e and label_e  != max_label:
                            update_array(a, min_label,label_e)
